...
namespace MYBSProje
{
    public partial class frmİlaclar : Form
    {
        ...
        {
            baglanti.Open();
            string ekle = "insert into tblılaclar (barkod_numarasi,ilac_adi, ilac_tip,kutu_adet) values(@p1, @p2, @p3,@p4)";
            ...
            cmd.Parameters.AddWithValue("@p4", int.Parse(txtKutuAdet.Text));
